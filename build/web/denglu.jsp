  ...
  <div class="index">
	<div class="top">
		<div class="logo">
            ...
            <div class="logo2"><marquee direct="left" ><font size="+1" class="biaoyu"><h2>欢迎您登录云鱼石机票预定系统</h2></font></marquee></div>
            </div> 
            <div class="a2" >  
            ...
            <table>
                <tr><td><font color="green">身份证号：</font></td><td><input type="text" name="user" class="w1"></td></tr>
                 ...
                 <tr><td colspan="2" align="center"><br><input type="submit" value="登录" class="w2">
                         <br> <a href="zhuce.jsp"><font size="2px" color="blue">我没有账号，立即注册></font></a></td></tr>
            </table> 
        </form>       </center>  
        </div>     
 </div>        
